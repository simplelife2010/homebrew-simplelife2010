cask "logitech-capture" do
  ...
  url "https://download01.logi.com/web/ftp/pub/techsupport/capture/Capture_2.04.08.zip",
  ...
  installer script: {
    executable: "Logi Capture Installer 2.04.08.app/Contents/MacOS/LogiMgr Installer",
    sudo:       true,
  }
